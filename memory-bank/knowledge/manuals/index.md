...
| [paradigma-harness-update.md](paradigma-harness-update.md) | `paradigma-manual` | Paradigma Harness Update | 套件更新<br>结构迁移<br>诊断 ... | pd-diagnose.py<br>installed_distribution_version<br>INIT_PROMPT mode H | related_to:/domains/design-system.md<br>related_to:/manuals/paradigma-design-wizard.md<br>related_to:/manuals/paradigma-baseline-test.md |
